          ...
          <div class="order-content">
            ...
            <div class="orders">
              <table class="order-item" v-for="item in orderList" :key="item.id">
                ...
                <tbody>
                  <tr v-for="(data,index) in item.orderDetailList" :key="data.id">
                    <td width="60%">
                      <div class="typographic">
                        <img :src="data.imgUrl" style="width:100px;height:100px;">
                        <a href="#" class="block-text">{{data.skuName}}</a>
...
export default {
  ...
  computed:{
    // 订单列表
    orderList(){
      return this.dataInfo.records
    }
  },
  methods:{
    async getOrderlist(){
      let res = await this.$API.myOrderList(this.page,this.limit)
