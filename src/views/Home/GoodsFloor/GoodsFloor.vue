        ...
        <div class="floor">
            <div class="py-container">
                <div class="title clearfix">
                    <h3 class="fl">{{datalist.name}}</h3>
                    <div class="fr">
                        <ul class="nav-tabs clearfix">
                            <li class="active" v-for="(item,index) in datalist.navList" :key="index">
                ...
                <div class="tab-content">
                    <div class="tab-pane">
                        <div class="floor-1">
                            <div class="blockgary">
                                <ul class="jd-list">
                                    <li  v-for="(item,index) in datalist.keywords" :key="index">{{item}}</li>
                                </ul>
                                <img :src="datalist.imgUrl" />
                            </div>
                            <div class="floorBanner">
                                <my-swiper :list="datalist.carouselList"></my-swiper>
                            </div>
                            <div class="split">
